...
if /i "%Edition11%"=="12" goto "SureEdition11"
echo Invalid syntax!
goto "Edition11"
...
if /i "%Edition3%"=="1" (echo Core) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition3%"=="2" (echo CoreSingleLanguage) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition3%"=="3" (echo Professional) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="1" (echo Core) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="2" (echo CoreN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="4" (echo Education) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="5" (echo EducationN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="6" (echo Professional) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition7%"=="7" (echo ProfessionalN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="1" (echo Core) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="2" (echo CoreN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="4" (echo Education) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="5" (echo EducationN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="6" (echo Professional) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="7" (echo ProfessionalN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="8" (echo ProfessionalEducation) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="9" (echo ProfessionalEducationN) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="10" (echo ProfessionalWorkstations) >> "%DriveLetter%\sources\EI.cfg"
if /i "%Edition11%"=="11" (echo ProfessionalWorkstationsN) >> "%DriveLetter%\sources\EI.cfg"
...
if /i "%Edition3%"=="1" (echo Core) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition3%"=="2" (echo CoreSingleLanguage) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition3%"=="3" (echo Professional) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="1" (echo Core) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="2" (echo CoreN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="4" (echo Education) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="5" (echo EducationN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="6" (echo Professional) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition7%"=="7" (echo ProfessionalN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="1" (echo Core) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="2" (echo CoreN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="4" (echo Education) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="5" (echo EducationN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="6" (echo Professional) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="7" (echo ProfessionalN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="8" (echo ProfessionalEducation) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="9" (echo ProfessionalEducationN) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="10" (echo ProfessionalWorkstations) >> "%DriveLetter%\x86\sources\EI.cfg"
if /i "%Edition11%"=="11" (echo ProfessionalWorkstationsN) >> "%DriveLetter%\x86\sources\EI.cfg"
...
if /i "%Edition3%"=="1" (echo Core) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition3%"=="2" (echo CoreSingleLanguage) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition3%"=="3" (echo Professional) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="1" (echo Core) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="2" (echo CoreN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="4" (echo Education) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="5" (echo EducationN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="6" (echo Professional) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition7%"=="7" (echo ProfessionalN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="1" (echo Core) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="2" (echo CoreN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="3" (echo CoreSingleLanguage) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="4" (echo Education) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="5" (echo EducationN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="6" (echo Professional) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="7" (echo ProfessionalN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="8" (echo ProfessionalEducation) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="9" (echo ProfessionalEducationN) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="10" (echo ProfessionalWorkstations) >> "%DriveLetter%\x64\sources\EI.cfg"
if /i "%Edition11%"=="11" (echo ProfessionalWorkstationsN) >> "%DriveLetter%\x64\sources\EI.cfg"
